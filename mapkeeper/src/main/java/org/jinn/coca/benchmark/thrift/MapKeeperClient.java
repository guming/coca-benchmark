...
public class MapKeeperClient extends DB {
    ...
    public Status update(String table, String key,
        ...
        try {
            ...
            int result=ycsbThriftRet(succ, ResponseCode.RecordExists, ResponseCode.RecordNotFound);
            return Status.OK;
        } catch(TException e) {
            e.printStackTrace();
            return Status.ERROR;
    ...
    public Status delete(String table, String key) {
        try {
            int result=ycsbThriftRet(c.remove(table, bufStr(key)), ResponseCode.Success, ResponseCode.RecordExists);
            return Status.OK;
        } catch(TException e) {
            e.printStackTrace();
            return Status.ERROR;
